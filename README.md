...
<span style="color:#d9c314">This text uses a green hex code</span> NOTE: the sound will remember to be on next load, but the first time you need to unmute the feeds. </span>
