...
2. **Unzip it — don't just double-click it.** Double-clicking a ZIP only *peeks inside* it (you'll see the files, but they're still zipped — this is the #1 spot people get stuck). Instead: **right-click the downloaded ZIP → Extract All...** → **Extract.** ("Extract All..." is partway down the menu — *not* the "Open" options at the top, which just take you inside the still-zipped archive.) When it finishes, the real unzipped folder opens on its own — that's the one you'll use.
