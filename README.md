...
1. **Download it.** Click the green **`<> Code`** button (top of this page) → **Download ZIP**, then unzip it somewhere you'll keep it. *(Or clone the repo, if you use git.)*
2. **Open your extensions page** — go to `chrome://extensions` (or `edge://extensions`).
